...
class org_puesto extends modelo{
    ...
    public function alta_bd(): array|stdClass
    {
        ...
        if(!isset($this->registro['org_departamento_id'])){
            $org_departamento_id = (new org_departamento($this->link))->id_predeterminado();
            if(errores::$error){
                return $this->error->error(mensaje: 'Error al obtener predeterminado',data: $org_departamento_id);
            }
            $this->registro['org_departamento_id'] = $org_departamento_id;
