...
class org_empresa_html extends html_controler {
    ...
    private function selects_alta(PDO $link): array|stdClass
    {
        ...
        $select = (new cat_sat_regimen_fiscal_html(html: $html_base))->select_cat_sat_regimen_fiscal_id(cols: 12, con_registros:true,
        ...
        $select = (new dp_pais_html(html: $html_base))->select_dp_pais_id(cols: 6, con_registros:true,
            id_selected:-1,link: $link);
        if(errores::$error){
            return $this->error->error(mensaje: 'Error al generar select',data:  $select);
        ...
        $select = (new dp_estado_html(html: $html_base))->select_dp_estado_id(cols: 6, con_registros:false,
            id_selected:-1,link: $link);
        if(errores::$error){
            return $this->error->error(mensaje: 'Error al generar select',data:  $select);
        ...
        $select = (new dp_municipio_html(html: $html_base))->select_dp_municipio_id(cols: 6, con_registros:false,
            id_selected:-1,link:$link);
        if(errores::$error){
            return $this->error->error(mensaje: 'Error al generar select',data:  $select);
        ...
        $select = (new dp_cp_html(html: $html_base))->select_dp_cp_id(cols: 6, con_registros:false,
            id_selected:-1,link: $link);
        if(errores::$error){
            return $this->error->error(mensaje: 'Error al generar select',data:  $select);
        ...
        $select = (new dp_colonia_postal_html(html: $html_base))->select_dp_colonia_postal_id(cols: 12, con_registros:false,
            id_selected:-1,link: $link);
        if(errores::$error){
            return $this->error->error(mensaje: 'Error al generar select',data:  $select);
        ...
        $select = (new dp_calle_pertenece_html(html: $html_base))->select_dp_calle_pertenece_id(cols: 12, con_registros:false,
            id_selected:-1,link: $link);
        if(errores::$error){
            return $this->error->error(mensaje: 'Error al generar select',data:  $select);
        ...
        $select = (new dp_calle_pertenece_html(html: $html_base))->select_dp_calle_pertenece_entre1_id(cols: 6, con_registros:false,
            id_selected:-1,link: $link);
        if(errores::$error){
            return $this->error->error(mensaje: 'Error al generar select',data:  $select);
        ...
        $select = (new dp_calle_pertenece_html(html: $html_base))->select_dp_calle_pertenece_entre2_id(cols: 6, con_registros:false,
            id_selected:-1,link: $link);
        if(errores::$error){
            return $this->error->error(mensaje: 'Error al generar select',data:  $select);
