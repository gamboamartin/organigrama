...
use models\org_empresa_clasificada;
...
class controlador_org_empresa_clasificada extends system {
    ...
    public function __construct(PDO $link, stdClass $paths_conf = new stdClass()){
        ...
        $html = new org_empresa_clasificada_html();
    ...
    public function alta(bool $header, bool $ws = false): array|string
    {
        ...
        $select = (new org_tipo_empresa_html())->select_org_tipo_empresa_id(cols:12,con_registros:true,id_selected:-1,link: $this->link);
        if(errores::$error){
            $error = $this->errores->error(mensaje: 'Error al generar select',data:  $select);
            print_r($error);
            die('Error');
